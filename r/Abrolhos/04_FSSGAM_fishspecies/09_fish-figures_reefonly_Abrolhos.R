...
bossdat <- readRDS(paste0("outputs/Abrolhos/fish/reef_only/", name, "_BOSS_predicted_fish_ro.RDS")) %>%
  # dplyr::rename(species.richness = p_richness) %>%
  # mutate(z = abs(z))%>%
  glimpse()

bruvdat <- readRDS(paste0("outputs/Abrolhos/fish/reef_only/", name, "_BRUV_predicted_fish_ro.RDS")) %>%
  # dplyr::rename(species.richness = p_richness) %>%
  # mutate(z = abs(z))%>%
  glimpse()
...
# Build elements for plot 1; BOSS C rubescens REEF ONLY
p1 <- ggplot() +
 ...
 print(p1)
png(filename = "plots/Abrolhos/spatialplots/reefonly/Abrolhos_BOSS_C_rubescens_reefonly.png",
...
p1.5 <- ggplot() +
  ...
  print(p1.5)
 png(filename = "plots/Abrolhos/spatialplots/reefonly/Abrolhos_BRUV_C_rubescens_reefonly.png", 
...
p2 <- ggplot() +
  ...
  print(p2)
 png(filename = "plots/Abrolhos/spatialplots/reefonly/Abrolhos_BOSS_C_auricularis_reefonly.png", 
         width = 8, height = 4, res = 600, units = "in")        
...
p2.5 <- ggplot() +
  ...
  print(p2.5)
 png(filename = "plots/Abrolhos/spatialplots/reefonly/Abrolhos_BRUV_C_auricularis_reefonly.png", 
         width = 8, height = 4, res = 600, units = "in")   ##SAVEOUT     
...
print(p3)
 png(filename = "plots/Abrolhos/spatialplots/reefonly/Abrolhos_BOSS_L_miniatus_reefonly.png", 
...
print(p3.5)
 png(filename = "plots/Abrolhos/spatialplots/reefonly/Abrolhos_BRUV_L_miniatus_reefonly.png", 
         width = 8, height = 4, res = 600, units = "in")       ###SAVEOUT 
...
p4 <- ggplot() +
  ...
  print(p4)
png(filename = "plots/Abrolhos/spatialplots/reefonly/Abrolhos_BOSS_S_cyanolaemus_reefonly.png", 
        width = 8, height = 4, res = 600, units = "in")        
...
print(p4.5)
png(filename = "plots/Abrolhos/spatialplots/reefonly/Abrolhos_BRUV_S_cyanolaemus_reefonly.png", 
        width = 8, height = 4, res = 600, units = "in")        
...
ggsave(filename = "plots/Abrolhos/spatialplots/reefonly/BRUVBOSS_Abrolhos_reefonly_spatialplots.png", 
       plot = fish_Abrolhos, 
       width = 14, 
       height = 16, 
       dpi = 1200, 
...
C_auric_reefonly_Abrolhos <- p2.5 + p2 + plot_layout(ncol =2)
C_auric_reefonly_Abrolhos

ggsave(filename = "plots/Abrolhos/spatialplots/reefonly/BRUVBOSS_Abrolhos_reefonly_spatialplots_Cauric.png", 
       plot = C_auric_reefonly_Abrolhos, 
       width = 14, 
       height = 16, 
       dpi = 1200, 
       units = "in")
