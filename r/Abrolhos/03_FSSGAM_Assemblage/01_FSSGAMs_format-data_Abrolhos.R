...
#load habitat
allhab <- readRDS("data/staging/habitat/Abrolhos_habitat-bathy-derivatives.rds")%>%
  # dplyr::select(-status) %>%
  ga.clean.names()%>%
...
corr.pred.vars <- Abr.maxn %>%
  select(all_of(selected_cols))
##take out mean.relief and sd.relief and slope
...
saveRDS(Abr.maxn, "data/staging/Abrolhos/Abrolhos.maxn.rds")
write.csv(Abr.maxn, "data/staging/Abrolhos/Abrolhos.maxn.csv")
